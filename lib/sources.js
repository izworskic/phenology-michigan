...
// Saginaw Bay physical signals: NDBC buoy 45203 (live wind + water/air temp + waves),
// GLERL ice concentration (winter signal), GLSEA satellite lake-surface temp. All no key.
export async function fetchBay() {
  const out = { windDirDeg: null, windMph: null, waterTempF: null, airTempF: null, waveFt: null, iceConc: null, iceDate: null, glseaF: null, glseaDate: null };
  try {
